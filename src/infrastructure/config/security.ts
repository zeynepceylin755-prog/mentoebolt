...
export function getSecurityConfig(): SecurityConfig {
  ...
  return {
    jwt: {
      secret: env.JWT_SECRET || 'default-secret-key-change-this-in-production',
      expiresIn: env.JWT_EXPIRES_IN || '15m',
      refreshSecret: env.JWT_REFRESH_SECRET || 'default-refresh-secret-change-this-in-production',
